...
public class RifaDao implements IRifa {
    ...
    final static String SQL_INSERTAR = "INSERT INTO rifa (id, nombre, descripcion, premio, inicio, fin, puestos, valor_puesto, uid_usuario) VALUES (NULL, ?, ?, ?, ?, ?, ?, ?, ?)";
    final static String SQL_CONSULTAR = "SELECT * FROM rifa r, usuario u WHERE r.uid_usuario = u.uid";
    final static String SQL_BORRAR = "DELETE FROM rifa WHERE id = ?";
    final static String SQL_CONSULTARID = "SELECT * FROM rifa r, usuario u WHERE r.id = ? AND r.uid_usuario = u.uid";
    ...
    final static String SQL_GET_RIFAS_CREADAS = "SELECT * FROM usuario u, rifa r WHERE r.uid_usuario = u.uid AND u.uid = ?";
    ...
    public int insertar(Rifa rifa) {
        ...
        try {
            ...
            sentencia.setString(8, rifa.getUsuario().getUid());
    ...
    public List<Rifa> consultar() {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                Usuario u = new Usuario(uid, nomUsuario, correo, telefono, registro);
    ...
    public List<Rifa> getRifasCreadas(Usuario usuario) {
        ...
        try {
            ...
            id nombre correo usuario telefono foto registro
                ...
                Usuario user = new Usuario(uid, nomUsuario, correo, telefono, registro);
